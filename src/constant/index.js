  ...
  const projects = [
    {
      name: "Cryptohub",
      description:
        "A React-Redux platform using RapidAPI for real-time crypto prices, trends, and news, ensuring seamless performance and up-to-date data.",
      tags: [
        {
          name: "React-Redux",
    ...
    },
    {
      name: "Apple Clone",
      description:
        "A modern replica of the Apple website with seamless animations, responsive layouts, and integrated error tracking for a polished user experience.",
      tags: [
        {
          name: "React.js",
          color: "blue-text-gradient",
    ...
    },
    {
      name: "Google Gemini ",
      description:
        "A visually engaging web app the Google Gemini website, featuring smooth animations, responsive design, and real-time error monitoring for optimal performance.",
      tags: [
        {
          name: "Node.js",
          color: "blue-text-gradient",
